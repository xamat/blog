...
## The detector detour and the watermarking trap
...
But beyond the fact that AI is largely undetectable, we should ask why we want to detect it in the first place, and whether it actually matters.

This brings us to the recent controversy around Anthropic implementing invisible watermarking for Claude in response to EU regulations. Ben Thompson at Stratechery [recently dismantled](https://tech.yahoo.com/ai/claude/articles/tech-analyst-ben-thompson-dismisses-181201718.html) this approach, pointing out the philosophical absurdity of the premise. As Thompson rightly asked: what exactly is "fake"? If an LLM states a verifiable fact, and a human writes a complete fable, does it matter that the human's fable doesn't have a watermark?Thompson argues that insisting an AI watermark itself is no different than insisting a ballpoint pen advertise itself as the author. He is exactly right.
