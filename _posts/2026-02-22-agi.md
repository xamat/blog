...
[Recently](https://www.businessinsider.com/deepmind-ceo-demis-hassabis-agi-real-intelligence-gap-2026-2), Hassabis pointed to Large Language Models making mistakes in basic math as evidence of a "real intelligence gap" on the road to AGI. But this completely misses the point. LLMs are probabilistic predictors. Expecting billions of frozen neural weights to perform flawless, symbolic arithmetic is an architectural mismatch; it is like using a hammer to turn a screw.

The solution to an LLM failing at math isn't to train a larger, more expensive monolith or to expect another breakthrough. The solution is simply to give the model a calculator.
