...
2. [Beyond the basics](#Beyond)
    ...
    2.3. [Explore/exploit](#explorerexploit)
    2.4. [Full page optimization](#page)
    2.5. [Context-aware recommendations and other approaches](#context)
    2.6. [Reinforcement learning](#RL)
3. [Deep Learning for recommendations](#DL)
    3.1. [The Deep Basics](#DeepBasics)
    3.2. [Embeddings](#embeddings)
    3.3. [Graph Neural Networks](#gnn)
    3.4. [Recommending Sequences](#sequences)
    3.5. [LLMs for recommendations](#llms)
